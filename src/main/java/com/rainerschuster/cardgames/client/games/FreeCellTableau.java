...
public class FreeCellTableau extends Tableau {
  ...
  public FreeCellTableau(CardGame cardGame, String id, Building buildingAdd,
      Building buildingRemove) {
    super(cardGame, id, buildingAdd, buildingRemove);
  }

  public FreeCellTableau(CardGame cardGame, String id, CGLayout layout,
      CGVisibility visibility, CGEmptyStart emptyStart, Building buildingAdd,
      Building buildingRemove) {
  ...
  public boolean acceptsRemoveAll(List<Card> cards) {
    System.out.println("overwritten acceptsRemoveAll");
